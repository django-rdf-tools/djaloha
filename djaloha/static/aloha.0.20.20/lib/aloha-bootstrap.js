...
define('util/strings',['aloha/jquery'],function($){
...
define('aloha/selection',[ 'aloha/core', 'aloha/jquery', 'util/class', 'util/arrays', 'util/strings', 'util/range', 'aloha/engine', 'aloha/console', 'PubSub', 'aloha/rangy-core' ],
...
* along with this program. If not, see <http://www.gnu.org/licenses/>.
*/
define('aloha/floatingmenu',['aloha/core', 'aloha/jquery', 'aloha/ext', 'util/class', 'aloha/console', 'vendor/jquery.store', 'aloha/selection'],
 ...
 *
 */
define('aloha/registry',['aloha/jquery', 'aloha/observable', 'util/class'],
